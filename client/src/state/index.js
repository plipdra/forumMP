...
export const { setMode, setLogin, setLogout, setOrder, setUser, setUsers, setPosts, setEditPost, setEditComment, setFullPost, setPost, setComments, setComment } = authSlice.actions;
